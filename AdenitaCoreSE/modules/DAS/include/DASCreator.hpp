...
namespace DASCreator {
    ...
    */
    SB_EXPORT ADNPointer<ADNDoubleStrand> CreateDoubleStrand(ADNPointer<ADNPart> part, int length, SBPosition3 start, SBVector3 direction, bool mock = false);
    ...
    /*!
      ...
      \param direction vector
    */
    SB_EXPORT ADNPointer<ADNSingleStrand> CreateSingleStrand(ADNPointer<ADNPart> part, int length, SBPosition3 start, SBVector3 direction, bool mock = false);

    SB_EXPORT ADNPointer<ADNLoop> CreateLoop(ADNPointer<ADNSingleStrand> ss, ADNPointer<ADNNucleotide> nextNt, const std::string& seq, ADNPointer<ADNPart> part = nullptr);
    ...
    */
    SB_EXPORT ADNPointer<ADNPart> CreateNanotube(SBQuantity::length radius, SBPosition3 center, SBVector3 direction, int length, bool mock = false);
    ...
    /*!
      ...
      \param length of the nanotube in base pairs
    */
    SB_EXPORT ADNPointer<ADNPart> CreateMockNanotube(SBQuantity::length radius, SBPosition3 center, SBVector3 direction, int length);
    ...
    /*!
      ...
      \param whether to create a mock part containing only the high-level details
    */
    SB_EXPORT ADNPointer<ADNPart> CreateDSRing(SBQuantity::length radius, SBPosition3 center, SBVector3 normal, bool mock = false);
    ...
    /*!
      ...
      \param whether to create a mock part containing only the high-level details
    */
    SB_EXPORT ADNPointer<ADNPart> CreateSSRing(SBQuantity::length radius, SBPosition3 center, SBVector3 normal, bool mock = false);
    ...
    /*!
      ...
      \param whether to create a mock part containing only the high-level details
    */
    SB_EXPORT ADNPointer<ADNPart> CreateLinearCatenanes(SBQuantity::length radius, SBPosition3 center, SBVector3 normal, int number, bool mock = false);
    ...
    /*!
      ...
      \param whether to create a mock part containing only the high-level details
    */
    SB_EXPORT ADNPointer<ADNPart> CreateHexagonalCatenanes(SBQuantity::length radius, SBPosition3 center, SBVector3 normal, int rows, int cols, bool mock = false);
    ...
    */
    SB_EXPORT ADNPointer<ADNDoubleStrand> AddRingToADNPart(ADNPointer<ADNPart> part, SBQuantity::length radius, SBPosition3 center, SBVector3 normal, bool ssDNA, bool mock = false);
    ...
    */
    SB_EXPORT RTDoubleStrand AddDoubleStrandToADNPart(ADNPointer<ADNPart> part, const size_t length, SBPosition3 start, SBVector3 direction, bool mock = false);
    ...
    /*!
      ...
      \param direction of the double strand
    */
    SB_EXPORT RTDoubleStrand AddSingleStrandToADNPart(ADNPointer<ADNPart> part, const size_t length, SBPosition3 start, SBVector3 direction);
