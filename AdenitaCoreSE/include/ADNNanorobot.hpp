...
public:
    ...
    [[nodiscard]] unsigned int                                  GetNumberOfParts() const;                                               ///< Returns the number of parts
    [[nodiscard]] unsigned int                                  GetNumberOfDoubleStrands() const;                                       ///< Returns the number of double strands
    [[nodiscard]] unsigned int                                  GetNumberOfBaseSegments() const;                                        ///< Returns the number of base segments
    [[nodiscard]] unsigned int                                  GetNumberOfSingleStrands() const;                                       ///< Returns the number of single strands
    [[nodiscard]] unsigned int                                  GetNumberOfNucleotides() const;                                         ///< Returns the number of nucleotides
