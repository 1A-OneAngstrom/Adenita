...
class SB_EXPORT SEAdenitaImporterAdn : public SBIFileImporter {
...
public:
	...
	[[nodiscard]] virtual std::string							getFilter() const override;														///< Returns the filter of the importer
	[[nodiscard]] virtual std::string							getExtension() const override;													///< Returns the extension of the importer
